...
public class CRC16 implements Checksum {
	private static final int[] CRC16_TABLE_HIGH = {0x00, 0x11, 0x23, 0x32, 0x46,
	...
	private static final int[] CRC16_TABLE_LOW = {0x00, 0x89, 0x12, 0x9B, 0x24,
	...
	public void update(byte[] b, int off, int len) {
		...
		for (int i = off; i < off + len; i ++) {
			index = low ^ b[i];
			low = high ^ CRC16_TABLE_LOW[index];
			high = CRC16_TABLE_HIGH[index];
		}
		
		crc = (short)(~(high << 8) + low);
	}
